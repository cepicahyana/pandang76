<?php echo $this->load->view("temp_dsh/head"); ?>
...
<body style='background-color:#E6E6FA'>
	<div class="wrapper horizontal-layout-2 ">
		...
		<div class="main-header bg-secondary-gradient ">
			<div class="nav-top">
				<div class="container d-flex flex-row">
					...
					echo $this->load->view("temp_dsh/navbar_souvenir");
			...
			echo $this->load->view("temp_dsh/menu_souvenir");
		...
		<div class="col mt-3">
			...
			<?php echo $this->load->view("temp_dsh/konten"); ?>
			<?php echo $this->load->view("temp_dsh/quick"); ?>
		</div>


	</div>
	<?php echo $this->load->view("temp_dsh/footer"); ?>
