						...
						<div class="container-fluid p-0">
							...
							<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
								...
								<li class="nav-item active dropdown hidden-caret">
									<a class="nav-link dropdown-toggle menuclick" href="<?php echo base_url() ?>mode_vicon">
								...
								<li class="nav-item dropdown hidden-caret">
									<a class="nav-link dropdown-toggle menuclick" href="<?php echo base_url() ?>page_undangan">
										<i class="fa fa-angle-double-right"></i>  Mode undangan fisik
									</a> 
								</li>
							 ...
							 <li class="nav-item dropdown hidden-caret">
									<a class="nav-link dropdown-toggle menuclick" href="<?php echo base_url() ?>page_souvenir">
