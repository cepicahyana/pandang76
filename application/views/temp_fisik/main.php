<?php echo $this->load->view("temp_fisik/head"); ?>
...
<body style='background-color:#E6E6FA'>
	<div class="wrapper horizontal-layout-2 ">
		...
		<div class="main-header bg-primary-gradient ">
			<div class="nav-top">
				<div class="container d-flex flex-row">
					...
					<!-- Navbar Header -->
					<?php
					echo $this->load->view("temp_fisik/navbar_souvenir");
					?>
			...
			echo $this->load->view("temp_fisik/menu_souvenir");

			?>
		</div>


		<?php echo $this->load->view("temp_fisik/konten"); ?>
		<?php echo $this->load->view("temp_fisik/quick"); ?>

	</div>
	<?php echo $this->load->view("temp_fisik/footer"); ?>
