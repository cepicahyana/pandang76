<?php echo $this->load->view("temp_souvenir/head"); ?>
...
<body style='background-color:#E6E6FA'>
	<div class="wrapper horizontal-layout-2 ">
		...
		<div class="main-header bg-danger-gradient ">
			<div class="nav-top">
				<div class="container d-flex flex-row">
					...
					<!-- Navbar Header -->
					<?php
					echo $this->load->view("temp_souvenir/navbar_souvenir");
					?>
			...
			echo $this->load->view("temp_souvenir/menu_souvenir");
		...
		<div class="col mt-3">
			<br>
			<br>
			<?php echo $this->load->view("temp_souvenir/konten"); ?>
			<?php echo $this->load->view("temp_souvenir/quick"); ?>

		</div>
		<?php echo $this->load->view("temp_souvenir/footer"); ?>
