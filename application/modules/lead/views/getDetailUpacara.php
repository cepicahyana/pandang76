...
<div class="col-md-12">
	...
	<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
		<div class="px-2 pb-2 pb-md-0 text-center">
			...
			<h6 class="fw-bold "><?php echo $per=$this->event->getJmlPemohon(); ?></h6>
		</div>
		<div class="px-2 pb-2 pb-md-0 text-center">
			<div id="circles-5"></div>
			<h6 class="fw-bold mt-3 mb-0">Verifikasi</h6>
			<h6 class="fw-bold "><?php echo $ver=$this->event->jmlDispo(); ?></h6>
		</div>
		<div class="px-2 pb-2 pb-md-0 text-center">
			<div id="circles-6"></div>
			<h6 class="fw-bold mt-3 mb-0">Distribusi</h6>
			<h6 class="fw-bold "><?php echo $number_format($this->umum->per_distribusi(),0,"","."); ?></h6>
		</div>
	</div>
	<hr>
</div>
