...
function kode(kode,dispo)
{
	if(dispo!=1)
	{	$("#data").html("");
		notif("Permohonan belum didisposisi!"); return false;
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
   ...
   var  dataTable = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('penyerahan/ajax_persus/')?>",
            "type": "POST",
			"data": function ( data ) {
...
function broadcast(){
	...
	{	 
		 loading();
		 $.post("<?php echo site_url("penyerahan/setStsPenyiapan"); ?>",{id:id},function(data){
