...
foreach($data as $val)
{
	...
	$qr1=$qr1="<input value='".$val->barcode3."' type='text' size='30' style='border:grey solid 1px' id='kod1".$urut."'
...
{			var url="<?php echo base_url();?>penyerahan/setKodeSuci";
			 loading();
...
<script language="Javascript">
	...
	Jenis Undangan : <?php echo $this->m_reff->goField("tr_kategory","nama","where id='".$database->jenis_permohonan."' ");?><br> 
