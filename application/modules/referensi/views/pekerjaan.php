 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">Data referensi pekerjaan  
        		...
        		<table id='table' width="100%" class="tabel black table-striped table-bordered table-hover dataTable">
				  	<thead>
				  		<tr>
				  				...
				  				<th class='thead'  width='15px'>&nbsp;URUTAN</th>
								<th class='thead'  width='15px'>&nbsp;ID</th>
									<th class='thead' >NAMA PEKERJAAN (INDONESIA)</th> 
									<th class='thead' >NAMA PEKERJAAN (BHS. INGGRIS)</th>  
...
swal({
						...
						if (willDelete) {
							swal("akun "+akun+" telah dihapus", {
							   ...
							   $.post("<?php echo site_url("referensi/hapus"); ?>",{id:id},function(){
							   reload_table();
							  });
  ...
  var  dataTable = $('#table').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('referensi/getDataPekerjaan');?>",
            "type": "POST",
			"data": function ( data ) {
			   data.level =12;
		 },
...
function add()
{
			$.post("<?php echo site_url("referensi/viewAdd"); ?>",{},function(data){
 ...
 <div class="modal fade" id="mdl_modal_artikel" tabindex="-1" role="dialog">
	...
	<form  action="javascript:submitFormAkun('modal_artikel')" id="modal_artikel" url="<?php echo base_url()?>referensi/insert_pekerjaan"   method="post" enctype="multipart/form-data">
...
<script>
	 ...
	 {	 
			 ...
			 $.post("<?php echo site_url("referensi/viewEdit"); ?>",{id:id},function(data){
		 	   $("#editan").html(data);
	 ...
	 {	 
			 ...
			 $.post("<?php echo site_url("referensi/set"); ?>",{id:id,sts:sts},function(data){
		 	   reload_table();
 ...
 <div class="modal fade" id="mdl_modal_edit" tabindex="-1" role="dialog">
	...
	<form  action="javascript:submitFormAkun('modal_edit')" id="modal_edit" url="<?php echo base_url()?>referensi/update_pekerjaan"  method="post" enctype="multipart/form-data">
                    <div class="modal-content">  
