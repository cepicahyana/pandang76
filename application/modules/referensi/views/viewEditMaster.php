 <?php $database=$this->db->get_where("tm_pengaturan",array("id"=>$this->input->post("id")))->row();  
  ...
  <div class="row clearfix">
							...
							<div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8  ">
                                        <div class="form-group">
                                            <div class="form-line"  >
											<input   required class=" form-control" name="f[pengaturan]" value="<?php echo $database->pengaturan;?>" type="text">
                                            </div>
                                        </div>
                                    </div>
                                </div> 
						  ...
						  <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8  ">
                                        <div class="form-group">
                                            <div class="form-line"  >
											<textarea   required class=" form-control" name="f[val]"  type="text"><?php echo $database->val;?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>  
