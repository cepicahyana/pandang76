				...
				<div class='row card-body' style='padding-top:10px;padding-bottom:20px'>	 
					...
					<option value="1"> Sudah verfikasi</option>
					<option value="3"> Draft</option>
					<option value="2"> Belum verfikasi</option> 
					</select>
					</div>	
					...
					<option value="2"> Belum siap</option> 
					 ...
					 <table id='table' width="100%" class="tabel black table-striped table-bordered table-hover dataTable">
					  <thead  >	 
									...
									<th    class='thead'>Jml Undangan </th>  
									<th    class='thead ' ><center>Verifikasi</center></th> 
									<th    class='thead ' ><center>Penyiapan Undangan</center></th> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" id="area_edit">
	    ...
	    <div class="modal-footer" style="margin:auto;">
	        ...
	        <button type="submit" class="btn btn-danger" onclick="delete_peserta_lainnya()">Yakin, Hapus</button>
	    </div>
    </div>
  </div>
</div>			
...
<script type="text/javascript">
	...
	function delete_peserta_lainnya(){
		var id = $("#getId").val();
		loading("area_delete");
		$.post("<?php echo base_url()?>permohonan/delete_peserta_lainnya",{id:id},function(data){
  ...
  <script type="text/javascript">
   ...
   var  dataTable = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('permohonan/ajax_lainnya')?>",
            "type": "POST",
			"data": function ( data ) {
