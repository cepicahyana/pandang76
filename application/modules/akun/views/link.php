 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">Generate Link Join
				  	...
				  	<thead>
				  		<tr>
				  				<th class='thead'  width='15px'>&nbsp;NO</th> 
									...
									<th class='thead' style="width:30px">JUMLAH PERSESI</th>
									<th class='thead' width="150px">SESI</th> 
									<th class='thead' width="50px">EKSKUSI</th>
									<th class='thead' width="150px">PROGRESS</th> 
				  		</tr>	 
					</thead>
				</table>
        	</div>
  ...
  <script type="text/javascript">
  	 function submit(id){ 
							  loading();
							   $.post("<?php echo site_url("akun/get_link"); ?>",{id:id},function(data){
							   unblock();
							   notif(data);
							   reload_table();
							  });
	 ...
	 function setLeng(id,val){ 
								loading();
							   $.post("<?php echo site_url("akun/setLeng"); ?>",{id:id,val:val},function(){
							   unblock();
							  }); 
	  };
	
	 function setPage(id,val){ 
								loading();
							   $.post("<?php echo site_url("akun/setPage"); ?>",{id:id,val:val},function(){
							   unblock();
							  }); 
	  };
  ...
  var  dataTable = $('#table').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('akun/getDataRoomLink');?>",
            "type": "POST",
			"data": function ( data ) {
