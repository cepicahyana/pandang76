 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">Akun Vicon 
				  	...
				  	<thead>
				  		<tr>
				  				<th class='thead'  width='15px'>&nbsp;NO</th>
									<th class='thead' >NAMA AKUN</th> 
									<th class='thead' >KEY</th> 
									<th class='thead' >SECREET</th>	 
...
swal({
						...
						if (willDelete) {
							swal("akun "+akun+" telah dihapus", {
							   ...
							   $.post("<?php echo site_url("akun/hapus_vicon"); ?>",{id:id},function(){
							   reload_table();
							  });
  ...
  var  dataTable = $('#table').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('akun/getData_vicon');?>",
            "type": "POST",
			"data": function ( data ) {
			   data.level =12;
		 },
...
function add()
{
			$.post("<?php echo site_url("akun/viewAdd_vicon"); ?>",{},function(data){
 ...
 <div class="modal fade" id="mdl_modal_artikel" tabindex="-1" role="dialog">
	...
	<form  action="javascript:submitFormAkun('modal_artikel')" id="modal_artikel" url="<?php echo base_url()?>akun/insert_vicon"   method="post" enctype="multipart/form-data">
...
<script>
	 ...
	 {	 
			 ...
			 $.post("<?php echo site_url("akun/viewEdit_vicon"); ?>",{id:id},function(data){
		 	   $("#editan").html(data);
	 ...
	 {	 
			 ...
			 $.post("<?php echo site_url("akun/set_vicon"); ?>",{id:id,sts:sts},function(data){
		 	   reload_table();
 ...
 <div class="modal fade" id="mdl_modal_edit" tabindex="-1" role="dialog">
	...
	<form  action="javascript:submitFormAkun('modal_edit')" id="modal_edit" url="<?php echo base_url()?>akun/update_vicon"  method="post" enctype="multipart/form-data">
                    <div class="modal-content">  
