...
<textarea class='form-control' name="kontent_wa" id="kontent_wa" style='min-height:150px' onchange="save_konten(`52`,this.value)"><?php echo $this->m_reff->tm_pengaturan(52)?></textarea>
</div>
...
<div class='col-md-9'> <input  type="text" class='form-control' name='subject' onchange="save_konten(`49`,this.value)" value="<?php echo $this->m_reff->tm_pengaturan(49)?>"> </div>
</div>

<br>
<textarea class='form-control' name="val" id="kontent" style='min-height:200px' ><?php echo $this->m_reff->tm_pengaturan(48)?></textarea>
<br>
