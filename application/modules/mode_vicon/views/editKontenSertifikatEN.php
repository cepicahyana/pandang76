...
?>
<form action="javascript:submitForm('form_konten_sertifikat')" id='form_konten_sertifikat' url="<?php echo base_url()?>zoom/save_konten_sertifikat_EN" method="post">
...
<textarea class='form-control' name="kontent_wa" id="kontent_wa" style='min-height:150px' onchange="save_konten(`69`,this.value)"><?php echo $this->m_reff->tm_pengaturan(69)?></textarea>
</div>
<div class="row col-md-12"> <hr></div>
 
<div class="row">
<div class='col-md-3' style='text-align:right'><span style="margin-top:230px"><br> <b class='text-primary'>Subject  :</b></span> </div>
<div class='col-md-9'> <input  type="text" class='form-control' name='subject' onchange="save_konten(`68`,this.value)" value="<?php echo $this->m_reff->tm_pengaturan(68)?>"> </div>
</div>

<br>
<textarea class='form-control' name="email" id="kontent_EN" style='min-height:200px' ><?php echo $this->m_reff->tm_pengaturan(67)?></textarea>
<br>
