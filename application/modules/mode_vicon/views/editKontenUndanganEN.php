<div id="area_form_konten_undangan">
<?php
$id		=	$this->input->get_post("val");
$jml	=	count($this->m_reff->clearkomaray($id));
error_reporting(0);
?>
<form action="javascript:submitForm('form_konten_undangan')" id='form_konten_undangan' url="<?php echo base_url()?>zoom/save_konten_undangan_EN" method="post">
...
<div class='col-md-12'> 
 <button class='btn btn-sm pull-right' onclick="submitForm('form_konten_undangan')" style='margin-top:-10px;margin-left:-220px'>Simpan</button> 
<br>

<div class='col-md-12'> 
<b class='text-primary'>Konten Whatsapp:</b> 
<textarea class='form-control' name="kontent_wa" id="kontent_wa" style='min-height:150px' onchange="save_konten(`77`,this.value)"><?php echo $this->m_reff->tm_pengaturan(77)?></textarea>
</div>
<div class="row col-md-12"> <hr></div>
 
<div class="row">
<div class='col-md-3' style='text-align:right'><span style="margin-top:230px"><br> <b class='text-primary'>Subject  :</b></span> </div>
<div class='col-md-9'> <input  type="text" class='form-control' name='subject' onchange="save_konten(`78`,this.value)" value="<?php echo $this->m_reff->tm_pengaturan(78)?>"> </div>
</div>

<br>
<textarea class='form-control' name="email" id="kontent_EN" style='min-height:200px' ><?php echo $this->m_reff->tm_pengaturan(79)?></textarea>
<br>
...
(link) klik disini (unlink)	=	Link Join<br>
								...
								<script>
								var editor =  CKEDITOR.replace('kontent_EN'); 
