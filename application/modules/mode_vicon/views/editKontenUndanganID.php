...
error_reporting(0);
?>
<form action="javascript:submitForm('form_konten_undangan')" id='form_konten_undangan' url="<?php echo base_url()?>zoom/save_konten_undangan_ID" method="post">
...
<textarea class='form-control' name="kontent_wa" id="kontent_wa" style='min-height:150px' onchange="save_konten(`73`,this.value)"><?php echo $this->m_reff->tm_pengaturan(73)?></textarea>
</div>
<div class="row col-md-12"> <hr></div>
 
<div class="row">
<div class='col-md-3' style='text-align:right'><span style="margin-top:230px"><br> <b class='text-primary'>Subject  :</b></span> </div>
<div class='col-md-9'> <input  type="text" class='form-control' name='subject' onchange="save_konten(`74`,this.value)" value="<?php echo $this->m_reff->tm_pengaturan(74)?>"> </div>
</div>

<br>
<textarea class='form-control' name="email" id="kontent_ID" style='min-height:200px' ><?php echo $this->m_reff->tm_pengaturan(75)?></textarea>
<br>
