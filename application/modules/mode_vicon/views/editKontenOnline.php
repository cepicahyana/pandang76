...
<textarea class='form-control' name="kontent_wa" id="kontent_wa" style='min-height:150px' onchange="save_konten(`53`,this.value)"><?php echo $this->m_reff->tm_pengaturan(53)?></textarea>
</div>
...
<div class='col-md-9'> <input  type="text" class='form-control' name='subject' onchange="save_konten(`51`,this.value)" value="<?php echo $this->m_reff->tm_pengaturan(51)?>"> </div>
</div>

<br>
<textarea class='form-control' name="val" id="kontent" style='min-height:200px' ><?php echo $this->m_reff->tm_pengaturan(50)?></textarea>
<br>
