...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
		 ...
		 <span style="float:right;color:white;margin-top:10px"><img src="<?php echo base_url();?>plug/img/pb.png" width="50px"> <b class="sadow">PHOTOBOTH</b></span>
        </div>
...
function izinkan(id)
    {
       ...
       var  url = "<?php echo base_url();?>myevent/izinkanPb/<?php echo $this->uri->segment(3);?>";
       // ajax adding data to database
          $.ajax({
            url : url,
            type: "POST",
...
function save()
	...
	var ID=$("#ID").val();
      ...
      var  url = "<?php echo base_url();?>myevent/CheckPb/<?php echo $this->uri->segment(3);?>";
       // ajax adding data to database
          $.ajax({
            url : url,
            type: "POST",
