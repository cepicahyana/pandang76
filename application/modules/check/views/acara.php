...
<head>
    ...
    <title>HUT RI <?php echo $this->m_reff->tm_pengaturan(31);?></title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
			...
			<img src="<?php echo base_url()?>plug/img/istana.png" height="50px" class="pull-left">
                ...
                <a class="navbar-brand sadow" href=""><b>RANGKAIAN ACARA HUT RI <?php echo $this->m_reff->tm_pengaturan(31);?>  </b></a>
...
function save()
	...
	var ID=$("#ID").val();
      ...
      var  url = "<?php echo base_url();?>check/CheckRegisterAcara/<?php echo $this->uri->segment(3);?>";
       // ajax adding data to database
          $.ajax({
            url : url,
            type: "POST",
