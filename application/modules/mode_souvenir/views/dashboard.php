...
<div class="col-12 col-sm-6 col-md-4">
								...
								<div class="card-body  bubble-shadow">
									<div class="d-flex justify-content-between">
										<div class="btn btn-secondary btn-sm btn-block  bubble-shadow" style='opacity:0.8'>
											<center><h5><b>   V V I P</b></h5></center>
									...
									<div class="d-flex justify-content-between mt-2">
										...
										<p class="text-muted mb-0"><?php echo $total11=$this->mdl->getJumlahPersediaan(1)?></p>
									</div>
									<div class="d-flex justify-content-between mt-2">
										<p class="text-muted mb-0">Total permohonan</p>
										<p class="text-muted mb-0"><?php echo $input11=$this->mdl->getJmlPemohon(1)?></p>
									</div><div class="d-flex justify-content-between mt-2">
										<p class="text-muted mb-0">Telah distribusi</p>
										<p class="text-muted mb-0"><?php echo $dis11=$this->mdl->getJmlPemohonDistribusi(1)?></p>
									</div><div class="d-flex justify-content-between mt-2">
 ...
 <div class="col-12 col-sm-6 col-md-4">
							<div class="card ">
								...
								<div class="d-flex justify-content-between mt-2">
										<p class="text-muted mb-0">Total persediaan </p>
										<p class="text-muted mb-0"><?php echo $total12=$this->mdl->getJumlahPersediaan(2)?></p>
									</div>
									<div class="d-flex justify-content-between mt-2">
										<p class="text-muted mb-0">Total permohonan</p>
										<p class="text-muted mb-0"><?php echo $input12=$this->mdl->getJmlPemohon(2)?></p>
									</div><div class="d-flex justify-content-between mt-2">
										<p class="text-muted mb-0">Telah distribusi</p>
										<p class="text-muted mb-0"><?php echo $dis12=$this->mdl->getJmlPemohonDistribusi(2)?></p>
									</div><div class="d-flex justify-content-between mt-2">
										<p class="text-muted mb-0">Sisa stok</p>
 ...
 <div class="col-12 col-sm-6 col-md-4">
							<div class="card">
								...
								<div class="d-flex justify-content-between mt-2">
										<p class="text-muted mb-0">Total persediaan </p>
										<p class="text-muted mb-0"><?php echo $total13=$this->mdl->getJumlahPersediaan(3)?></p>
									</div>
									<div class="d-flex justify-content-between mt-2">
										<p class="text-muted mb-0">Total permohonan</p>
										<p class="text-muted mb-0"><?php echo $input13=$this->mdl->getJmlPemohon(3)?></p>
									</div><div class="d-flex justify-content-between mt-2">
										<p class="text-muted mb-0">Telah distribusi</p>
										<p class="text-muted mb-0"><?php echo $dis13=$this->mdl->getJmlPemohonDistribusi(3)?></p>
									</div><div class="d-flex justify-content-between mt-2">
										<p class="text-muted mb-0">Sisa stok</p>
						...
						<div class="col-md-6 ">
							<div class="card ">
								<div class="card-body   ">
								  	<div class="col-black"><h4>Persentase permohonan</h4></div>
					 
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										
										<div class="px-2 pb-2 pb-md-0 text-center"> 
											<div id="circles-1"><?php echo $persen1=$this->mdl->persenPermohonan($total11,$input11);?></div>
											<h6 class="fw-bold mt-3 mb-0">VVIP</h6>
											 
										</div>
										<div class="px-2 pb-2 pb-md-0 text-center"> 
											<div id="circles-2"><?php echo $persen2=$this->mdl->persenPermohonan($total12,$input12);?></div>
											<h6 class="fw-bold mt-3 mb-0">VIP</h6> 
										</div>
										
										 
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="circles-3"><?php echo $persen3=$this->mdl->persenPermohonan($total13,$input13);?></div>
						...
						<div class="col-md-6 ">
							<div class="card ">
								<div class="card-body   ">
								  	<div class="col-black"><h4>Persentase pendistribusian </h4></div>
					 
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										<div class="px-2 pb-2 pb-md-0 text-center"> 
											<div id="circles-4"><?php echo  $persen4=$this->mdl->persenPermohonan($input11,$dis11);?></div>
											<h6 class="fw-bold mt-3 mb-0">VVIP</h6>
											 
										</div>
										<div class="px-2 pb-2 pb-md-0 text-center"> 
											<div id="circles-5"><?php echo $persen5=$this->mdl->persenPermohonan($input12,$dis12);?></div>
											<h6 class="fw-bold mt-3 mb-0">VIP</h6> 
										</div>
										
										 
										<div class="px-2 pb-2 pb-md-0 text-center">
											<div id="circles-6"><?php echo $persen6=$this->mdl->persenPermohonan($input13,$dis13);?></div>
											<h6 class="fw-bold mt-3 mb-0">UMUM</h6>
